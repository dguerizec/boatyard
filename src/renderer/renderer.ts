...
const paneLayoutView = createPaneLayoutView({
  ...
  isWebAppTabMenuOpen,
  closeWebAppTabMenu,
  openPaneExpansionMenu: (event, onKeep) => webAppMenus.openPaneExpansionMenu(event, onKeep),
...
const webAppMenus = createWebAppMenus({
  ...
  freezeWebAppsForOverlayRect: (rect) => webAppMenuFreezeScope.freezeForMainRect(rect, { margin: 8 }),
